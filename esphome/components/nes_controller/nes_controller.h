...
class NESController : public Component {
 public:
  ...
  // Add similar setter methods for other buttons
 ...
 protected:
  ...
  binary_sensor::BinarySensor *a_button_sensor{nullptr};
  binary_sensor::BinarySensor *b_button_sensor{nullptr};
  // Declare other button sensors as pointers
